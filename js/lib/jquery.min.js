...
("undefined" != typeof window ? window : this, function (a, b) {
	...
	!function () {
		...
		l.html5Clone = "<:nav/>" !== d.createElement("nav").cloneNode(!0).outerHTML,
		c.type = "checkbox",
		c.checked = !0,
		b.appendChild(c),
		...
		if (j.style) {
			...
			function k() {
				...
				f && (j.style.display = "", j.innerHTML = "<table>
						...
						</table>", j.childNodes[0].style.borderCollapse = "separate", k = j.getElementsByTagName("td"), k[0].style.cssText = "margin:0;border:0;padding:0;display:none", f = 0 === k[0].offsetHeight, f && (k[0].style.display = "", k[1].style.display = "none", f = 0 === k[0].offsetHeight)),
				m.removeChild(i)
			}
		}
	}
